    ...
    <q-card class="details-dialog">
      ...
      <q-card-section>
        ...
        <q-form class="dialog-form-grid" @submit.prevent="submitForm">
          <q-input v-model="form.first_name" outlined dense label="Nombres" class="soft-input" />
          <q-input v-model="form.last_name" outlined dense label="Apellidos" class="soft-input" />
          <q-select
          ...
          <q-input
            ...
            class="soft-input"
          />
          <q-input v-model="form.mobile_phone" outlined dense label="Celular" class="soft-input" />
          <q-input v-model="form.landline_phone" outlined dense label="Telefono convencional" class="soft-input" />
