    ...
    <section class="panel data-panel">
      <div class="table-toolbar">
        <q-input
          ...
          dense
          debounce="250"
          placeholder="Buscar casa, condominio o dueño"
          ...
          <q-td :props="props">
            <div class="row-actions">
              <q-btn
                ...
                label="Editar casa"
                no-caps
                :disable="!props.row.actions.edit"
              ...
              <q-btn
                ...
                label="Nuevo dueño"
                no-caps
                :disable="!props.row.actions.invite_user"
                @click="goToCreateOwner(props.row)"
              />
            </div>
          </q-td>
        </template>
        ...
        <template #item="props">
          <div class="condo-grid-card">
            ...
            <div class="condo-grid-card__details">
              ...
              <span>Dueño<strong>{{ props.row.ownerName }}</strong></span>
...
import { updateAdminHouse } from '../services/houses.service';
...
const ownerFilterOptions = [
  { label: 'Todos los dueños', value: 'all' },
  { label: 'Con dueño', value: 'with-owner' },
  { label: 'Sin dueño', value: 'without-owner' },
];
