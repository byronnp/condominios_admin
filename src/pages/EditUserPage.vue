  ...
  <q-page class="dashboard-page">
    ...
    <q-form class="create-layout" @submit.prevent="submitForm">
      <section class="panel form-panel">
        <div class="panel-header"><div><h2>Datos del usuario</h2><p>Informacion visible para administradores.</p></div></div>
        <div class="form-grid">
...
const records: Record<string, UserForm> = {
  '1': { name: 'Daniel Perez', email: 'daniel@email.com', condominium: 'Mirador Norte', property: 'Casa B-14', role: 'Residente', status: 'Activo' },
  '2': { name: 'Lucia Castro', email: 'lucia@email.com', condominium: 'Portal del Bosque', property: 'Depto 302', role: 'Propietario', status: 'Activo' },
  '3': { name: 'Rafael Mora', email: 'rafael@email.com', condominium: 'Las Cumbres', property: 'Casa A-07', role: 'Residente', status: 'Pendiente' },
};
