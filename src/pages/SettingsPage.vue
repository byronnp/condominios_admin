  ...
  <q-page class="dashboard-page">
    ...
    <section class="create-layout">
      <div class="panel form-panel">
        ...
        <div class="form-grid">
          <q-input v-model="settings.platformName" outlined dense label="Nombre de plataforma" class="soft-input" />
          <q-select v-model="settings.timezone" outlined dense :options="timezoneOptions" label="Zona horaria" class="soft-input" />
          <q-select v-model="settings.currency" outlined dense :options="currencyOptions" label="Moneda" class="soft-input" />
          <q-select v-model="settings.language" outlined dense :options="languageOptions" label="Idioma" class="soft-input" />
        </div>
      </div>
