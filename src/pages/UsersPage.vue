  ...
  <q-page class="dashboard-page">
    ...
    <section class="panel data-panel">
      <div class="table-toolbar">
        <q-input v-model="filter" outlined dense debounce="250" placeholder="Buscar usuario" class="soft-input table-toolbar__search">
        ...
        <template #body-cell-actions="props">
          <q-td :props="props">
            <div class="row-actions">
              ...
              <q-btn flat color="primary" icon="edit" label="Editar" :to="`/usuarios/${props.row.id}/editar`" no-caps />
            </div>
          </q-td>
        </template>
        <template #item="props">
