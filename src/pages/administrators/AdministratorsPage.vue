  ...
  <q-page class="dashboard-page">
    ...
    <section class="panel data-panel">
      <div class="table-toolbar">
        <q-input v-model="filter" outlined dense hide-bottom-space debounce="250" placeholder="Buscar administrador" class="soft-input table-toolbar__search">
        ...
        <template #body-cell-actions="props">
          <q-td :props="props">
            <div class="row-actions">
              ...
              <q-btn flat round dense color="primary" icon="edit" :to="`/administradores/${props.row.id}/editar`">
...
import AdministratorDetailsDialog from './components/AdministratorDetailsDialog.vue';
