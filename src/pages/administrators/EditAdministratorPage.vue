...
import { confirmedRule, minLengthRule, requiredRule } from '../../composables/shared/form-rules';
...
import { getCondominiumAdminById, updateCondominiumAdmin } from '../../services/condominiums/condominiums.service';
...
const passwordRule = (value: string) =>
  !hasPasswordChange.value && !value ? true : minLengthRule(8, 'La contrasena')(value);
const passwordConfirmationRule = (value: string) =>
  !hasPasswordChange.value && !value ? true : confirmedRule(form.password, value);
