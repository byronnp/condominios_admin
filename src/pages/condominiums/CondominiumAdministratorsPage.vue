        ...
        <template #body-cell-actions="props">
          <q-td :props="props">
            <div class="row-actions">
              <q-btn flat round dense color="primary" icon="edit" @click="openEditAdmin(props.row)">
              ...
              >
                <q-tooltip>Eliminar administrador</q-tooltip>
              </q-btn>
            </div>
          </q-td>
        </template>
...
import AssignCondominiumAdminDialog from './components/AssignCondominiumAdminDialog.vue';
import ConfirmDialog from 'components/general/ConfirmDialog.vue';
import { useCondominiumAdmins } from '../../composables/condominiums/useCondominiumAdmins';
import type {
...
} from '../../services/condominiums/condominiums.service';
...
async function submitAdminForm(
  ...
  try {
    if (selectedAdmin.value) {
      ...
      await createCondominiumAdmin(condominiumId.value, payload);
    }
