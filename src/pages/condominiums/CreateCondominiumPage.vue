      ...
      <section class="panel form-panel">
        ...
        <div class="form-grid">
          ...
          <q-input
            ...
            class="soft-input"
            hide-bottom-space
            :rules="[requiredRule('El numero de casas')]"
            :disable="saving"
          />
        </div>
      </section>
...
} from '../../interfaces/condominiums/create-condominium-form.interface';
import { createAdminCondominium } from '../../services/condominiums/condominiums.service';
