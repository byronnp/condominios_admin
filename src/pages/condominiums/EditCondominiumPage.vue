      ...
      <section class="panel form-panel">
        ...
        <div class="form-grid">
          <q-input
            ...
            class="soft-input"
            hide-bottom-space
            :rules="[requiredRule('El nombre del condominio')]"
          />
          <q-input
            v-model="form.ruc"
            outlined
            ...
            class="soft-input"
            hide-bottom-space
            :rules="[requiredRule('El RUC o identificacion')]"
          />
          <q-input
            v-model="form.city"
            outlined
          ...
          <q-input
            ...
            hide-bottom-space
            :rules="[requiredRule('La direccion completa')]"
          />
          <q-input
            ...
            class="soft-input"
            hide-bottom-space
            :rules="[requiredRule('El total de casas')]"
          />
          <q-select
            v-model="form.status"
            outlined
            ...
            class="soft-input"
            hide-bottom-space
            :rules="[requiredRule('El estado operativo')]"
...
} from '../../interfaces/condominiums/edit-condominium-form.interface';
import { getAdminCondominiumById, updateAdminCondominium } from '../../services/condominiums/condominiums.service';
