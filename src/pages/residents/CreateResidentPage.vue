  ...
  <q-page class="dashboard-page">
    <section class="page-heading">
      <div>
        ...
        <p>Registra un residente con sus datos principales, vivienda y relacion.</p>
      </div>

      <div class="heading-actions">
        <q-btn outline color="primary" icon="arrow_back" label="Volver" to="/residentes" no-caps />
        <q-btn color="primary" icon="save" label="Guardar residente" no-caps @click="submitForm" />
      </div>
    </section>
    ...
    <q-form ref="formRef" class="create-layout" @submit.prevent="submitForm">
      <section class="panel form-panel">
        <div class="panel-header">
          <div>
            ...
            <p>Usa los campos que veran los administradores en la ficha.</p>
          </div>
        </div>
      ...
      <aside class="panel summary-panel">
        <div class="panel-header">
          <div>
            <h2>Resumen</h2>
            <p>Verifica la informacion antes de guardar.</p>
          </div>
        </div>
...
async function submitForm() {
  ...
  console.info('Residente listo para guardar', { ...form });
}
</script>
