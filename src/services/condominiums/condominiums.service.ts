...
import type { CreateCondominiumPayload } from '../../interfaces/condominiums/create-condominium-form.interface';
import type { UpdateCondominiumPayload } from '../../interfaces/condominiums/edit-condominium-form.interface';
import type {
...
export async function createCondominiumAdmin(
  ...
  return apiPost<unknown, CreateCondominiumAdminPayload | UpdateCondominiumAdminPayload>(
